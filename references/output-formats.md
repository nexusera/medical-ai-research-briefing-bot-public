...
## 🔬 1. 轨道 A: 高级学术综述模式 (Broad Synthesis - 全景脉络)
...
## ⚡ 2. 轨道 B: 高级前沿快报模式 (Solution-Oriented Flash - 最优解合成)
*检索侧重短窗口近期文献，但每篇论文的分析框架与高级学术综述完全统一。在完成论文拆解后，额外输出"最优组合解决方案"。*
