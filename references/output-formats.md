...
- **时间窗口**: [当次设定的具体时间范围，如 2026-02-23 to 2026-02-25。**若启用 Related 检索则必须标明 "Related-mode (no recency window)" 并写出"近 3 年优先 + 来源权重优先"的约束条件。**]
...
*(不预先根据主观设定主题簇，直接进行单篇实体论文的结构化拆解)*

1. **[论文标题 A](明确的原文链接)** (来源: [期刊/会议/预印本])
   - **标签**: [方向: MDT/Medical LLM/In-silico/OCR] [机制: 协作机制/决策支持/等，绝不推断]
   - **结构化分析**: 
